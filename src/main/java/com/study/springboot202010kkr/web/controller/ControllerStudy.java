...
import com.study.springboot202010kkr.web.dto.RequestStudyDto;
...
public class ControllerStudy {
    ...
    public String 요청데이터Obj(RequestStudyDto dto){
        return dto.toString();
    }

    @ResponseBody
    @PostMapping("/study/student/1")
    public String getJsonAjax(@RequestBody RequestStudyDto dto) {
        return dto.toString();
    }
    ...
    public ResponseEntity<?> getJsonAjax2() {
        RequestStudyDto dto = new RequestStudyDto();
        dto.setName("aaa");
        dto.setEmail("aaa@naver.com");
        dto.setAddress("부산 망미동");
